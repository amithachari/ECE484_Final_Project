...
print(os.path.abspath('xy_demo_online.csv'))
    ...
    def start_pp(self):
        ...
        while not rospy.is_shutdown():
            ...
            with open('/home/gem/Apollo_ws/src/vehicle_drivers/gem_gnss/scripts/xy_demo_online.csv', 'w') as file:
                ...
                file.write('%f,%f,%f\n'%(curr_x,curr_y,curr_yaw,current_time))
            # goal_x = 0.0
            # goal_y = 0.0
            # dist_goal = np.sqrt((curr_x - goal_x)**2 + (curr_y - goal_y) **2)
            # # dist_goal = np.abs(curr_x - goal_x)
            # if self.brake_now or dist_goal < 0.8:
            #     self.brake_now = True
            #     print("BRAKING NOW")
            #     self.accel_cmd.f64_cmd = 0.0
            ...
            self.turn_pub.publish(self.turn_cmd)
            rospy.loginfo("Sending Control Signal")
